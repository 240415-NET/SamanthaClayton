...
class Program
{
    ...
    {
        List<string> userGroceryList = new List<string>();
        bool keepAlive=true;
        Menu();
       ...
       void SelectionHandler(int userMenuSelection){
        ...
        switch(userMenuSelection)
            ...
            case 2:  //add to the grocery list 
                ...
                do
                {Console.WriteLine("Enter the item you'd like to add:");
                string newuserGroceryItem = Console.ReadLine();
            ...
            Console.WriteLine("What item would you like to modify in your grocery list?");
                ...
                string userModifySelectionDesc = userGroceryList[userModifySelection];
                ...
                userGroceryList[userModifySelection] = userRevisedSelectionDesc;
